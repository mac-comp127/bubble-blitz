...
public class BubbleTest {
    ...
    /**
     * Tests whether the bubble isCannonBallWithin method appropriate reports if a cannonball intersects it
...
//        assertFalse(bubble.isCannonBallWithin(ball));
//        for(int i = 1; i<25; i++){
//            ball = new CannonBall(i, 0, 0,0,0,0);
//            assertTrue(bubble.isCannonBallWithin(ball));
//        }
